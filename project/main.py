...
def color_function(sensor):
    ...
    color = light.rgb()
    print(color)
    if 6<color[0]<12 and 14<color[1]<36 and 22<color[2]<77:
        our_color = "Blue"
        sensor()

    elif 47<color[0]<51 and 35<color[1]<39 and 6<color[2]<8:
        our_color = "Yellow"
        sensor()
 
    elif 14<color[0]<16 and 14<color[1]<15 and 8<color[2] <10:
        our_color ="Brown"
        sensor()

    elif 3<color[0]<12 and 2<color[1]<9 and 9<color[2]<32:
        "our color = Purple"
        sensor()
    
    elif 6<color[0]<10 and 19<color[1]<34 and 5<color[2]<17:
        "our color = Green"
        sensor()
